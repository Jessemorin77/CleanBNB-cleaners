...
function BidScreen({ route, navigation }: Props) {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: "black" }}>
      <View>
        <Text className="p-16 text-center text-3xl text-white">
          Place a Bid
        </Text>
        <TextInput
          className="mb-4 border-b border-white text-white"
        ...
        >
          <Text className="text-center text-white">Place Bid</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
