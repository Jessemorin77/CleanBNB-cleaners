      ...
      <ScrollView className="h-full">
        <View className=" w-full p-4">
          <Text className="mx-auto pb-2 text-4xl font-bold text-white">
            Clean<Text className="text-[#cc66ff]">BNB</Text>-Owners
          </Text>
          <TouchableOpacity>
            <View className="m-4 overflow-hidden rounded-lg bg-white shadow">
              ...
              />
              <Text className="p-1 text-lg font-bold ">
                Upload a Listing to find Cleaners!
              </Text>
            </View>
          </TouchableOpacity>
          ...
          <TouchableOpacity>
            <View className="m-4 overflow-hidden rounded-lg bg-white shadow">
              <Image
                ...
                className="h-40 w-full"
              />
              <Text className="p-1 text-lg font-bold">View Bids</Text>
            </View>
          </TouchableOpacity>
